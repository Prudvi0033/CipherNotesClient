...
const GlowButton = ({
  ...
  return (
    <button
      className={cn(
        "hover:opacity-[0.90] text-[18px] rounded-[1.1rem] border font-extralight  relative overflow-hidden after:absolute after:content-[''] after:inset-0 after:[box-shadow:0_0_15px_-1px_#ffffff90_inset] after:rounded-2xl before:absolute before:content-[''] before:inset-0  before:rounded-2xl flex items-center before:z-20 after:z-10",
